...
program_path = os.path.join(user_home, "Desktop", "StatusMonitor", "OpenHardwareMonitor_v0.9.6", "OpenHardwareMonitor.exe")
...
# 사용자로부터 포트 번호 입력 받기
port_number = input("아두이노 COM Port 번호를 입력하세요: ")
try:
...
while True:
    ...
    if cpu_temp is not None and gpu_temp is not None:
        ...
        data = f"a{cpu_temp}c{gpu_temp}e\n"
        print()
